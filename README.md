...
2. Create a GitHub personal token following these [instructions](https://docs.github.com/en/authentication/keeping-your-account-and-data-secure/managing-your-personal-access-tokens#creating-a-personal-access-token-classic). Once the token is generated, give it permission to perform every action listed on the GitHub page (check all the boxes).
