...
-	Interactive graphics, with scatter plots, barplots, geographical plots… cosa ancora?
...
-	Cluster analysis (hierarchical clustering, K-means, PAM, and methods for assessing cluster quality such as silhutette…
Qualcosa per l’analisi genetica….vedi
